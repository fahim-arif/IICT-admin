      ...
      <Row>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#5bcfc5"  />
                <SparklinesReferenceLine type="mean" color="#5bcfc5"/>
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#5bcfc5"  style={{ fill: "none" }} />
                <SparklinesSpots />
              </Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#5bcfc5" />
                <SparklinesSpots style={{ fill: "#5bcfc5" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
		<Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData} >
				<SparklinesBars style={{ fill: '#5bcfc5', fillOpacity: ".6" }} />
				<SparklinesReferenceLine />
			</Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              ...
              >
                <SparklinesBars style={{ fill: "#5bcfc5" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
